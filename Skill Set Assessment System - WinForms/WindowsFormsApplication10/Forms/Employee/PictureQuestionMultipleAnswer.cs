...
{
    public partial class PictureQuestionMultipleAnswer : Form
    {
        ...
        //
        public PictureQuestionMultipleAnswer(Questions[] que, Answers[] ans, Bookmark[] b1, int ind, int timeleft1, Employee e, Exam_Details exd)
        {
            InitializeComponent();
            q = que;
            a = ans;
        ...
        //
        private void PictureQuestionMultipleAnswer_Load(object sender, EventArgs e)
        {
