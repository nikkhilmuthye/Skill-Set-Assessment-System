...
{
    public partial class MultipleAnswerTest : Form
    {
        ...
        //
        public MultipleAnswerTest(Questions[] que, Answers[] ans, Bookmark[] b1, int ind, int timeleft1, Employee e, Exam_Details exd)
        {
            InitializeComponent();
            q = que;
            a = ans;
        ...
        //
        private void MultipleAnswerTest_Load(object sender, EventArgs e)
        {
