<%@ Page Title="Exam" MasterPageFile="~/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="MultipleAnswerTest.aspx.cs" Inherits="WebApplication1.MultipleAnswerTest" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <aside style="background-color:lemonchiffon">
        ...
        <br />
        <br />
        <asp:Button runat="server" ID="bookmark" Text="Bookmark" OnClick="bookmark_Click" Height="39px" Width="135px" />
