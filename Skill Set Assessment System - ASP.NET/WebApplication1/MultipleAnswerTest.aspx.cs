...
{
    public partial class MultipleAnswerTest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            option1Label.Text = q[index].option1;
            option2Label.Text = q[index].option2;
            option3Label.Text = q[index].option3;
            option4Label.Text = q[index].option4;
        ...
        protected void timer1_tick(object sender, EventArgs e)
        {
            ...
            {
                timerLabel.Text = "Number of Minutes Left: " +
